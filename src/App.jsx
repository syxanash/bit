    ...
    <div className='app-container'>
      ...
      <Dialog isOpen={isDialogOpen} onClose={() => setIsDialogOpen(false)}>
        ...
        <p>
          ...
          The responses are generated by a <a href='https://huggingface.co/LiquidAI/LFM2-350M-GGUF/tree/main'>lightweight LLM</a> (only 229 MB!) running locally directly in your browser using <a href='https://github.com/ngxson/wllama'>Wllama</a>, a WebAssembly binding for llama.cpp.<br />
          Performance may vary depending on your hardware, faster chips such as Apple Silicon will allow smoother inference.<br /><br />
