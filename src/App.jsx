    ...
    <div className='app-container'>
      ...
      <Dialog isOpen={isDialogOpen} onClose={() => setIsDialogOpen(false)}>
        ...
        <p>
          ...
          The responses are generated by a <a href='https://huggingface.co/LiquidAI/LFM2-350M-GGUF/tree/main'>lightweight LLM</a> (only 229 MB!) running locally directly in your browser using <a href='https://github.com/ngxson/wllama'>Wllama</a>, a WebAssembly binding for llama.cpp. Since inference is done on the CPU, performance may vary depending on your hardware. Faster chips, such as Apple Silicon, will allow for smoother inference.<br /><br />
